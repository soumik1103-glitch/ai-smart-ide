...
import type { Dto } from "@codingame/monaco-vscode-api/vscode/vs/workbench/services/extensions/common/proxyIdentifier";
import { ITaskExecution } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/tasks/common/tasks";
