...
registerFileUrl('./themes/dark_modern.json', new URL('./resources/dark_modern.json', import.meta.url).toString(), {"mimeType":"application/json","size":4676});
...
registerFileUrl('./themes/hc_black.json', new URL('./resources/hc_black.json', import.meta.url).toString(), {"mimeType":"application/json","size":7081});
registerFileUrl('./themes/hc_light.json', new URL('./resources/hc_light.json', import.meta.url).toString(), {"mimeType":"application/json","size":8753});
registerFileUrl('./themes/light_modern.json', new URL('./resources/light_modern.json', import.meta.url).toString(), {"mimeType":"application/json","size":5476});
