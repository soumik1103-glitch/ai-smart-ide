...
class TextMateTokenizationWorker {
    ...
    async _loadTMGrammarFactory(grammarDefinitions, onigurumaWASMUri) {
        const vscodeTextmate = await import('@codingame/monaco-vscode-api/_virtual/main').then(function (n) { return n.main; });
        const vscodeOniguruma = await import('../../../../../../../../../_virtual/main2.js').then(function (n) { return n.main; });
