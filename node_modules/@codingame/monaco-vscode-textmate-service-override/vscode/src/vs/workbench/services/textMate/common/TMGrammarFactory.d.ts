...
import type { IGrammar, IOnigLib, IRawTheme, StateStack } from "@codingame/monaco-vscode-api/_virtual/main";
...
export declare class TMGrammarFactory extends Disposable {
    ...
    constructor(host: ITMGrammarFactoryHost, grammarDefinitions: IValidGrammarDefinition[], vscodeTextmate: typeof import("@codingame/monaco-vscode-api/_virtual/main"), onigLib: Promise<IOnigLib>);
