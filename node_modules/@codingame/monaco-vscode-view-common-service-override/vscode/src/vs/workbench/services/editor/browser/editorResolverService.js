...
let EditorResolverService = class EditorResolverService extends Disposable {
    ...
    async doHandleConflictingDefaults(resource, editorName, untypedInput, currentEditor, group) {
        ...
        const handle = this.notificationService.prompt(Severity.Warning, ( localize(13883, 'There are multiple default editors available for the resource.')), [{
                label: ( localize(13884, 'Configure Default')),
                run: async () => {
            ...
            {
                label: ( localize(13885, 'Keep {0}', editorName)),
    ...
    mapEditorsToQuickPickEntry(resource, showDefaultPicker) {
        ...
        const currentlyActiveLabel = ( localize(13886, "Active"));
        const currentDefaultLabel = ( localize(13887, "Default"));
        const currentDefaultAndActiveLabel = ( localize(13888, "Active and Default"));
        ...
        if (!showDefaultPicker && extname(resource) !== '') {
            ...
            const configureDefaultEntry = {
                ...
                label: ( localize(13889, "Configure default editor for '{0}'...", `*${extname(resource)}`)),
            };
    ...
    async doPickEditor(editor, showDefaultPicker) {
        ...
        const placeHolderMessage = showDefaultPicker ?
            ( localize(13890, "Select new default editor for '{0}'", `*${extname(resource)}`)) :
            ( localize(13891, "Select editor for '{0}'", basename(resource)));
