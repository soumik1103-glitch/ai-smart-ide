...
let HistoryService = class HistoryService extends Disposable {
    ...
    constructor(editorService, editorGroupService, contextService, storageService, configurationService, fileService, workspacesService, instantiationService, layoutService, contextKeyService, logService) {
        ...
        this.canNavigateBackContextKey = (( new RawContextKey('canNavigateBack', false, ( localize(14103, "Whether it is possible to navigate back in editor history"))))).bindTo(this.contextKeyService);
        this.canNavigateForwardContextKey = (( new RawContextKey('canNavigateForward', false, ( localize(14104, "Whether it is possible to navigate forward in editor history"))))).bindTo(this.contextKeyService);
        ...
        this.canReopenClosedEditorContextKey = (( new RawContextKey('canReopenClosedEditor', false, ( localize(14111, "Whether it is possible to reopen the last closed editor"))))).bindTo(this.contextKeyService);
