...
import { TypeHierarchyDirection, TypeHierarchyItem, TypeHierarchyModel } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/typeHierarchy/common/typeHierarchy";
