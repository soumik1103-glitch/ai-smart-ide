import { CharacterPair, CommentRule, ExplicitLanguageConfiguration, IAutoClosingPair, IAutoClosingPairConditional } from "@codingame/monaco-vscode-api/vscode/vs/editor/common/languages/languageConfiguration";
