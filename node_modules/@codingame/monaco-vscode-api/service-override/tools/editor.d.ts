...
import { type EditorInputWithOptions, type IActiveEditorChangeEvent, type IEditorCloseEvent, type IEditorControl, type IEditorPane, type IEditorWillOpenEvent, type IResourceDiffEditorInput, type ITextDiffEditorPane, type IUntitledTextResourceEditorInput, type IUntypedEditorInput, type IVisibleEditorPane } from "../../vscode/src/vs/workbench/common/editor.js";
import { EditorInput } from "../../vscode/src/vs/workbench/common/editor/editorInput.js";
import type { IEditorOptions, IResourceEditorInput, ITextResourceEditorInput } from "../../vscode/src/vs/platform/editor/common/editor.js";
import type { ICodeEditor, IDiffEditor } from "../../vscode/src/vs/editor/browser/editorBrowser.js";
import { type IEditorGroupView } from "../../vscode/src/vs/workbench/browser/parts/editor/editor.js";
...
import { type IStandaloneCodeEditor } from "../../vscode/src/vs/editor/standalone/browser/standaloneCodeEditor.js";
import { Disposable, type IDisposable, type IReference } from "../../vscode/src/vs/base/common/lifecycle.js";
import { EditorService } from "../../vscode/src/vs/workbench/services/editor/browser/editorService.js";
import { type IAuxiliaryEditorPart, type IEditorDropTargetDelegate, type IEditorPart, type IActiveEditorActions, type IEditorGroup, type IEditorWorkingSet, type IEditorGroupContextKeyProvider } from "../../vscode/src/vs/workbench/services/editor/common/editorGroupsService.js";
...
import type { IGroupModelChangeEvent } from "../../vscode/src/vs/workbench/common/editor/editorGroupModel.js";
import type { EditorLayoutInfo } from "../../vscode/src/vs/editor/common/config/editorOptions.js";
import type { IRectangle } from "../../vscode/src/vs/platform/window/common/window.js";
import type { ContextKeyValue } from "../../vscode/src/vs/platform/contextkey/common/contextkey.js";
...
export declare class MonacoDelegateEditorGroupsService<D extends IEditorGroupsService> extends Disposable implements IEditorGroupsService {
    ...
    onDidChangeEditorPartOptions: Event<import("../../vscode/src/vs/workbench/common/editor.js").IEditorPartOptionsChangeEvent>;
    enforcePartOptions: IEditorGroupsService["enforcePartOptions"];
}
export {};
