...
registerColor('diffEditor.move.border', '#8b8b8b9c', ( localize(204, 'The border color for text that got moved in the diff editor.')));
registerColor('diffEditor.moveActive.border', '#FFA500', ( localize(205, 'The active border color for text that got moved in the diff editor.')));
registerColor('diffEditor.unchangedRegionShadow', { dark: '#000000', light: '#737373BF', hcDark: '#000000', hcLight: '#737373BF', }, ( localize(206, 'The color of the shadow around unchanged region widgets.')));
const diffInsertIcon = registerIcon('diff-insert', Codicon.add, ( localize(207, 'Line decoration for inserts in the diff editor.')));
const diffRemoveIcon = registerIcon('diff-remove', Codicon.remove, ( localize(208, 'Line decoration for removals in the diff editor.')));
