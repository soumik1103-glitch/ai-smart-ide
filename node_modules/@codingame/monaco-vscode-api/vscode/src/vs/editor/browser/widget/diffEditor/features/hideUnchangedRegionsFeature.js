    ...
    constructor(_editors, _diffModel, _options, _instantiationService) {
        ...
        const unchangedLinesDecorationShow = {
            ...
            glyphMarginHoverMessage: ( new MarkdownString(undefined, { isTrusted: true, supportThemeIcons: true }))
                .appendMarkdown(( localize(192, 'Fold Unchanged Region'))),
    ...
    constructor(editor, _viewZone, _unchangedRegion, _hide = false) {
        ...
        this._register(autorun(reader => {
            if (!this._hide) {
                ...
                const linesHiddenText = ( localize(193, '{0} hidden lines', lineCount));
...
class CollapsedCodeOverlayWidget extends ViewZoneOverlayWidget {
    constructor(_editor, _viewZone, _unchangedRegion, _unchangedRegionRange, _hide, _modifiedOutlineSource, _revealModifiedHiddenLine, _options) {
        ...
        this._nodes = h('div.diff-hidden-lines', [
            h('div.top@top', { title: ( localize(194, 'Click or drag to show more above')) }),
            h('div.center@content', { style: { display: 'flex' } }, [
                h('div@first', { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: '0' } }, [$('a', { title: ( localize(195, 'Show Unchanged Region')), role: 'button', onclick: () => { this._unchangedRegion.showAll(undefined); } }, ...renderLabelWithIcons('$(unfold)'))]),
                h('div@others', { style: { display: 'flex', justifyContent: 'center', alignItems: 'center' } }),
            ]),
            h('div.bottom@bottom', { title: ( localize(196, 'Click or drag to show more below')), role: 'button' }),
        ]);
        root.root.appendChild(this._nodes.root);
        if (!this._hide) {
        ...
        this._register(autorun(reader => {
            ...
            if (!this._hide) {
                ...
                const linesHiddenText = ( localize(193, '{0} hidden lines', lineCount));
                const span = $('span', { title: ( localize(197, 'Double click to unfold')) }, linesHiddenText);
