...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: ( localize(187, "Use Inline View When Space Is Limited")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: ( localize(188, "Show Moved Code Blocks")),
        icon: Codicon.move,
...
for (const ctx of [
    ...
    MenuRegistry.appendMenuItem(MenuId.DiffEditorHunkToolbar, {
        command: {
            ...
            title: ( localize(189, "Revert Block")),
            icon: ctx.icon,
        },
    ...
    MenuRegistry.appendMenuItem(MenuId.DiffEditorSelectionToolbar, {
        command: {
            id: ( new RevertHunkOrSelection()).desc.id,
            title: ( localize(190, "Revert Selection")),
            icon: ctx.icon,
        },
        when: ( ContextKeyExpr.and(EditorContextKeys.diffEditorModifiedWritable, ctx.key)),
        order: 5,
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        ...
        title: ( localize(191, "Open Accessible Diff Viewer")),
        precondition: ( ContextKeyExpr.has('isInDiffEditor')),
    },
    order: 10,
    group: '2_diff',
