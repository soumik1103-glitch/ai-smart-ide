...
registerColor('editorGutter.foldingControlForeground', iconForeground, ( localize(1104, 'Color of the folding control in the editor gutter.')));
const foldingExpandedIcon = registerIcon('folding-expanded', Codicon.chevronDown, ( localize(1105, 'Icon for expanded ranges in the editor glyph margin.')));
const foldingCollapsedIcon = registerIcon('folding-collapsed', Codicon.chevronRight, ( localize(1106, 'Icon for collapsed ranges in the editor glyph margin.')));
const foldingManualCollapsedIcon = registerIcon('folding-manual-collapsed', foldingCollapsedIcon, ( localize(1107, 'Icon for manually collapsed ranges in the editor glyph margin.')));
const foldingManualExpandedIcon = registerIcon('folding-manual-expanded', foldingExpandedIcon, ( localize(1108, 'Icon for manually expanded ranges in the editor glyph margin.')));
const foldedBackgroundMinimap = { color: themeColorFromId(foldBackground), position: MinimapPosition.Inline };
const collapsed = ( localize(1109, "Click to expand the range."));
const expanded = ( localize(1110, "Click to collapse the range."));
