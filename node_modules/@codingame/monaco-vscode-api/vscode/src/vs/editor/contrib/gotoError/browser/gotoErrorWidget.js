    ...
    getAriaLabel(marker) {
        ...
        switch (marker.severity) {
            case MarkerSeverity.Error:
                severityLabel = ( localize(1124, "Error"));
                break;
            case MarkerSeverity.Warning:
                severityLabel = ( localize(1125, "Warning"));
                break;
            case MarkerSeverity.Info:
                severityLabel = ( localize(1126, "Info"));
                break;
            case MarkerSeverity.Hint:
                severityLabel = ( localize(1127, "Hint"));
                break;
        }
    ...
    showAtMarker(marker, markerIdx, markerCount) {
        ...
        if (model) {
            const detail = markerCount > 1
                ? ( localize(1129, "{0} of {1} problems", markerIdx, markerCount))
                : ( localize(1130, "{0} of {1} problem", markerIdx, markerCount));
...
const editorMarkerNavigationError = registerColor('editorMarkerNavigationError.background', { dark: errorDefault, light: errorDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1131, 'Editor marker navigation widget error color.')));
const editorMarkerNavigationErrorHeader = registerColor('editorMarkerNavigationError.headerBackground', { dark: ( transparent(editorMarkerNavigationError, .1)), light: ( transparent(editorMarkerNavigationError, .1)), hcDark: null, hcLight: null }, ( localize(1132, 'Editor marker navigation widget error heading background.')));
const editorMarkerNavigationWarning = registerColor('editorMarkerNavigationWarning.background', { dark: warningDefault, light: warningDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1133, 'Editor marker navigation widget warning color.')));
const editorMarkerNavigationWarningHeader = registerColor('editorMarkerNavigationWarning.headerBackground', { dark: ( transparent(editorMarkerNavigationWarning, .1)), light: ( transparent(editorMarkerNavigationWarning, .1)), hcDark: '#0C141F', hcLight: ( transparent(editorMarkerNavigationWarning, .2)) }, ( localize(1134, 'Editor marker navigation widget warning heading background.')));
const editorMarkerNavigationInfo = registerColor('editorMarkerNavigationInfo.background', { dark: infoDefault, light: infoDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1135, 'Editor marker navigation widget info color.')));
const editorMarkerNavigationInfoHeader = registerColor('editorMarkerNavigationInfo.headerBackground', { dark: ( transparent(editorMarkerNavigationInfo, .1)), light: ( transparent(editorMarkerNavigationInfo, .1)), hcDark: null, hcLight: null }, ( localize(1136, 'Editor marker navigation widget info heading background.')));
const editorMarkerNavigationBackground = registerColor('editorMarkerNavigation.background', editorBackground, ( localize(1137, 'Editor marker navigation widget background.')));
