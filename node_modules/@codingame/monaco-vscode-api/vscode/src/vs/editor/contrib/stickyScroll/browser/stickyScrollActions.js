...
class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1545, "Toggle Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1546, "&&Toggle Editor Sticky Scroll")),
            },
            metadata: {
            ...
            toggled: {
                ...
                title: ( localize(1548, "Sticky Scroll")),
                mnemonicTitle: ( localize(1549, "&&Sticky Scroll")),
            },
            menu: [
...
class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1550, "Focus Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1551, "&&Focus Editor Sticky Scroll")),
            },
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1552, "Select the next editor sticky scroll line")),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1553, "Select the previous sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1554, "Go to the focused sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1555, "Select Editor")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
