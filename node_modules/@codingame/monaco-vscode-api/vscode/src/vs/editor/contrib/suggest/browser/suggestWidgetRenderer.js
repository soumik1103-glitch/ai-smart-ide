...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, ( localize(1592, 'Icon for more information in the suggest widget.')));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = ( localize(1593, "Read More"));
        const configureFont = () => {
