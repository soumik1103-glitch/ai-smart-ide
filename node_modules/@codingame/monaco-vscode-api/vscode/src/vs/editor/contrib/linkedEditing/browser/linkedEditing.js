...
class LinkedEditingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1380, "Start Linked Editing")),
...
registerColor('editor.linkedEditingBackground', { dark: ( ( Color.fromHex('#f00')).transparent(0.3)), light: ( ( Color.fromHex('#f00')).transparent(0.3)), hcDark: ( ( Color.fromHex('#f00')).transparent(0.3)), hcLight: Color.white }, ( localize(1381, 'Background color when the editor auto renames on type.')));
