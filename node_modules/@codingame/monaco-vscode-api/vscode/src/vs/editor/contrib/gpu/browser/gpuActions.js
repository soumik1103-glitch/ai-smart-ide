...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1194, "Developer: Debug Editor GPU Renderer")),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([
            {
                label: ( localize(1195, "Log Texture Atlas Stats")),
                id: 'logTextureAtlasStats',
            },
            {
                label: ( localize(1196, "Save Texture Atlas")),
                id: 'saveTextureAtlas',
            },
            {
                label: ( localize(1197, "Draw Glyph")),
                id: 'drawGlyph',
            },
        ], { canPickMany: false });
        if (!choice) {
