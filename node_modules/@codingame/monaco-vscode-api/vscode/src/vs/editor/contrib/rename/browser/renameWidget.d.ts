...
export declare class RenameWidget implements IRenameWidget, IContentWidget, IDisposable {
    ...
    constructor(_editor: ICodeEditor, _acceptKeybindings: [
        string,
        string
    ], _themeService: IThemeService, _keybindingService: IKeybindingService, contextKeyService: IContextKeyService, _logService: ILogService);
    dispose(): void;
    getId(): string;
