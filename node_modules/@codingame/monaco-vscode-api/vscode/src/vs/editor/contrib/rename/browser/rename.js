...
class RenameSkeleton {
    ...
    async _provideRenameEdits(newName, i, rejects, token) {
        ...
        if (!result) {
            return this._provideRenameEdits(newName, i + 1, rejects.concat(( localize(1482, "No result."))), token);
        }
    ...
    async run() {
        ...
        try {
            ...
            if (e instanceof CancellationError) {
                ...
                if (typeof e === 'string' || isMarkdownString(e)) {
                    MessageController.get(this.editor)?.showMessage(e || ( localize(1483, "An unknown error occurred while resolving rename location")), position);
                }
            }
            return undefined;
        }
        ...
        const renameOperation = raceCancellation(skeleton.provideRenameEdits(inputFieldResult.newName, cts2.token), cts2.token).then(async (renameResult) => {
            ...
            this._bulkEditService.apply(renameResult, {
                ...
                label: ( localize(1484, "Renaming '{0}' to '{1}'", loc?.text, inputFieldResult.newName)),
                code: 'undoredo.rename',
                quotableLabel: ( localize(1485, "Renaming {0} to {1}", loc?.text, inputFieldResult.newName)),
                ...
                this._notificationService.error(( localize(1487, "Rename failed to apply edits")));
                this._logService.error(err);
            });
        }, err => {
            trace('error when providing rename edits', JSON.stringify(err, null, '\t'));
            this._notificationService.error(( localize(1488, "Rename failed to compute edits")));
            this._logService.error(err);
        }).finally(() => {
            cts2.dispose();
        });
...
class RenameAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1489, "Rename Symbol")),
...
registerAction2(class FocusNextRenameSuggestion extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1490, "Focus Next Rename Suggestion")),
            },
            precondition: CONTEXT_RENAME_INPUT_VISIBLE,
            keybinding: [
                {
...
registerAction2(class FocusPreviousRenameSuggestion extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1491, "Focus Previous Rename Suggestion")),
            },
            precondition: CONTEXT_RENAME_INPUT_VISIBLE,
            keybinding: [
                {
...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    properties: {
        'editor.rename.enablePreview': {
            ...
            description: ( localize(1492, "Enable/disable the ability to preview changes before renaming")),
            default: true,
            type: 'boolean'
        }
    }
