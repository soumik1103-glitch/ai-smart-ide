...
class DeleteInsideWord extends EditorAction {
    constructor() {
        super({
            id: 'deleteInsideWord',
            precondition: EditorContextKeys.writable,
            label: ( localize2(1675, "Delete Word")),
            metadata: {
                description: ( localize2(1676, "Delete the word at the cursor")),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'onlyWord': {
                                    type: 'boolean',
                                    default: false,
                                    description: ( localize(1677, "Delete only the word and leave surrounding whitespace"))
                                }
                            }
                        }
                    }]
