...
class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1246, "Convert Indentation to Spaces")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1247, "Convert the tab indentation to spaces.")),
            }
        });
    }
    run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1248, "Convert Indentation to Tabs")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1249, "Convert the spaces indentation to tabs.")),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = ( [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? ( localize(1250, "Configured Tab Size"))
                : n === creationOpts.tabSize
                    ? ( localize(1251, "Default Tab Size"))
                    : n === modelOpts.tabSize
                        ? ( localize(1252, "Current Tab Size"))
                        : undefined)
        })));
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: ( localize(1253, "Select Tab Size for Current File")), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: ( localize2(1254, "Indent Using Tabs")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1255, "Use indentation with tabs.")),
            }
        });
    }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: ( localize2(1256, "Indent Using Spaces")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1257, "Use indentation with spaces.")),
            }
        });
    }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: ( localize2(1258, "Change Tab Display Size")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1259, "Change the space size equivalent of the tab.")),
            }
        });
    }
}
class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1260, "Detect Indentation from Content")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1261, "Detect the indentation from content.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1262, "Reindent Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1263, "Reindent the lines of the editor.")),
            },
...
class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1264, "Reindent Selected Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1265, "Reindent the selected lines of the editor.")),
            },
            canTriggerInlineEdits: true,
        });
    }
