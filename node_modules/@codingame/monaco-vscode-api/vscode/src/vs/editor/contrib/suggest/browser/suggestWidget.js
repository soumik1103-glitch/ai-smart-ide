...
var SuggestWidget_1;
registerCss(suggest);
registerColor('editorSuggestWidget.background', editorWidgetBackground, ( localize(1573, 'Background color of the suggest widget.')));
registerColor('editorSuggestWidget.border', editorWidgetBorder, ( localize(1574, 'Border color of the suggest widget.')));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, ( localize(1575, 'Foreground color of the suggest widget.')));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, ( localize(1576, 'Foreground color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, ( localize(1577, 'Icon foreground color of the selected entry in the suggest widget.')));
const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, ( localize(1578, 'Background color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, ( localize(1579, 'Color of the match highlights in the suggest widget.')));
...
registerColor('editorSuggestWidgetStatus.foreground', ( transparent(editorSuggestWidgetForeground, .5)), ( localize(1581, 'Foreground color of the suggest widget status.')));
var State;
(function (State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = ( localize(1582, "Loading...")); }
    static { this.NO_SUGGESTIONS_MESSAGE = ( localize(1583, "No suggestions.")); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = ( new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => ( localize(1584, "Suggest")),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = ( localize(1585, '{0} {1}, {2}, {3}', label, detail, description, kindLabel));
                        }
                        else if (detail) {
                            label = ( localize(1586, '{0} {1}, {2}', label, detail, kindLabel));
                        }
                        else if (description) {
                            label = ( localize(1587, '{0}, {1}, {2}', label, description, kindLabel));
                        }
                    }
                    else {
                        label = ( localize(1588, '{0}, {1}', label, kindLabel));
                    }
                    ...
                    return localize(1589, "{0}, docs: {1}", label, docs);
                },
            }
        }));
