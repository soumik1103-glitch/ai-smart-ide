...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, ( localize(1056, 'Icon to indicate that the editor find widget is collapsed.')));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, ( localize(1057, 'Icon to indicate that the editor find widget is expanded.')));
const findSelectionIcon = registerIcon('find-selection', Codicon.selection, ( localize(1058, 'Icon for \'Find in Selection\' in the editor find widget.')));
const findReplaceIcon = registerIcon('find-replace', Codicon.replace, ( localize(1059, 'Icon for \'Replace\' in the editor find widget.')));
const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, ( localize(1060, 'Icon for \'Replace All\' in the editor find widget.')));
const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, ( localize(1061, 'Icon for \'Find Previous\' in the editor find widget.')));
const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, ( localize(1062, 'Icon for \'Find Next\' in the editor find widget.')));
const NLS_FIND_DIALOG_LABEL = ( localize(1063, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(1064, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(1065, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(1066, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(1067, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(1068, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(1069, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(1070, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(1071, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(1072, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(1073, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(1074, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(1076, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(1077, "No results"));
...
class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(1078, "{0} found", label))
                : ( localize(1079, "{0} found for '{1}'", label, searchString));
        }
        if (currentMatch) {
        ...
        return localize(1081, "{0} found for '{1}'", label, searchString);
    }
