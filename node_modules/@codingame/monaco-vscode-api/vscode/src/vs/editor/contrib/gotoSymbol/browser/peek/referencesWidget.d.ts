...
export declare class ReferenceWidget extends PeekViewWidget {
    ...
    private _dim;
    private _isClosing;
    constructor(editor: ICodeEditor, _defaultTreeKeyboardSupport: boolean, layoutData: LayoutData, themeService: IThemeService, _textModelResolverService: ITextModelService, _instantiationService: IInstantiationService, _peekViewService: IPeekViewService, _uriLabel: ILabelService, _keybindingService: IKeybindingService);
