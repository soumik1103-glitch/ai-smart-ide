...
const CONTEXT_RENAME_INPUT_VISIBLE = ( new RawContextKey('renameInputVisible', false, ( localize(1493, "Whether the rename input widget is visible"))));
...
class RenameCandidateListView {
    ...
    setCandidates(candidates) {
        ...
        status(( localize(1495, "Received {0} rename suggestions", candidates.length)));
    }
    clearCandidates() {
...
class InputWithButton {
    ...
    get domNode() {
        if (!this._domNode) {
            ...
            this._inputNode.setAttribute('aria-label', ( localize(1496, "Rename input. Type new name and press Enter to commit.")));
            this._domNode.appendChild(this._inputNode);
            this._buttonNode = createElement('div');
            this._buttonNode.className = 'rename-suggestions-button';
            this._buttonNode.setAttribute('tabindex', '0');
            this._buttonGenHoverText = ( localize(1497, "Generate New Name Suggestions"));
            this._buttonCancelHoverText = ( localize(1498, "Cancel"));
