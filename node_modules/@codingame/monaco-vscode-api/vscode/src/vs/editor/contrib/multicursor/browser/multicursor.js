...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? ( localize(1393, "Cursor added: {0}", cursorPositions)) : ( localize(1394, "Cursors added: {0}", cursorPositions));
        status(msg);
    }
}
class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1395, "Add Cursor Above")),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: ( localize(1396, "&&Add Cursor Above")),
                order: 2
            }
        });
    }
...
class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1397, "Add Cursor Below")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1398, "A&&dd Cursor Below")),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1399, "Add Cursors to Line Ends")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1400, "Add C&&ursors to Line Ends")),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1401, "Add Cursors to Bottom")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1402, "Add Cursors to Top")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1403, "Add Selection to Next Find Match")),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1404, "Add &&Next Occurrence")),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1405, "Add Selection to Previous Find Match")),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1406, "Add P&&revious Occurrence")),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1407, "Move Last Selection to Next Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1408, "Move Last Selection to Previous Find Match")),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1409, "Select All Occurrences of Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1410, "Select All &&Occurrences")),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1411, "Change All Occurrences")),
...
class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1412, "Focus Next Cursor")),
            metadata: {
                description: ( localize(1413, "Focuses the next cursor")),
                args: [],
            },
            precondition: undefined
        });
...
class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1414, "Focus Previous Cursor")),
            metadata: {
                description: ( localize(1415, "Focuses the previous cursor")),
                args: [],
            },
            precondition: undefined
        });
