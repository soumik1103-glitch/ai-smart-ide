...
class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1139, 'Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1140, "No definition found for '{0}'", info.word))
            : ( localize(1141, "No definition found"));
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1142, "Go to Definition")),
                mnemonicTitle: ( localize(1143, "Go to &&Definition")),
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1144, "Open Definition to the Side")),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1145, "Peek Definition")),
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1146, 'Declarations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1147, "No declaration found for '{0}'", info.word))
            : ( localize(1148, "No declaration found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1149, "Go to Declaration")),
                mnemonicTitle: ( localize(1150, "Go to &&Declaration")),
            },
...
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: ( localize2(1151, "Peek Declaration")),
            precondition: ( ContextKeyExpr.and(
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1152, 'Type Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1153, "No type definition found for '{0}'", info.word))
            : ( localize(1154, "No type definition found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1155, "Go to Type Definition")),
                mnemonicTitle: ( localize(1156, "Go to &&Type Definition")),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1157, "Peek Type Definition")),
            precondition: ( ContextKeyExpr.and(
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1158, 'Implementations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1159, "No implementation found for '{0}'", info.word))
            : ( localize(1160, "No implementation found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1161, "Go to Implementations")),
                mnemonicTitle: ( localize(1162, "Go to &&Implementations")),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1163, "Peek Implementations")),
            precondition: ( ContextKeyExpr.and(
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? ( localize(1164, "No references found for '{0}'", info.word))
            : ( localize(1165, "No references found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1166, "Go to References")),
                mnemonicTitle: ( localize(1167, "Go to &&References")),
            },
            precondition: ( ContextKeyExpr.and(
...
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: ( localize2(1169, "Peek References")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.hasReferenceProvider,
                PeekContext.notInPeekEditor,
                ( EditorContextKeys.isInEmbeddedEditor.toNegated())
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: ( localize2(1170, "Go to Any Symbol")),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return (new ReferencesModel(this._references, localize(1171, 'Locations')));
    }
    _getNoResultFoundMessage(info) {
        return info && ( localize(1172, "No results for '{0}'", info.word)) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), Position.lift(position), false, false, token).then(references => ( new ReferencesModel(references, ( localize(1168, 'References'))))));
