...
import { INLINE_EDITS_BORDER_RADIUS, getEditorBackgroundColor, modifiedBackgroundColor, getModifiedBorderColor } from '../theme.js';
    ...
    constructor(_editor, _input, _tabAction, instantiationService, _languageService) {
        ...
        this._modifiedOverlay = n.div({
            ...
            const separatorWidth = ( this._input.map(
                i => i?.editorType === InlineCompletionEditorType.DiffEditor ? WIDGET_SEPARATOR_DIFF_EDITOR_WIDTH : WIDGET_SEPARATOR_WIDTH
            )).read(reader);
