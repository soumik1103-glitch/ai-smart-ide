...
const $ = $$1;
const increaseHoverVerbosityIcon = registerIcon('hover-increase-verbosity', Codicon.add, ( localize(1231, 'Icon for increaseing hover verbosity.')));
const decreaseHoverVerbosityIcon = registerIcon('hover-decrease-verbosity', Codicon.remove, ( localize(1232, 'Icon for decreasing hover verbosity.')));
class MarkdownHover {
...
let MarkdownHoverParticipant = class MarkdownHoverParticipant {
    ...
    createLoadingMessage(anchor) {
        return (new MarkdownHover(
            this,
            anchor.range,
            [( new MarkdownString()).appendText(( localize(1233, "Loading...")))],
            false,
            2000
        ));
    }
...
class MarkdownRenderedHoverParts {
    ...
    _renderHoverExpansionAction(container, action, actionEnabled) {
        ...
        const hoverDelegate = store.add(( new WorkbenchHoverDelegate(
            'mouse',
            undefined,
...
function labelForHoverVerbosityAction(keybindingService, action) {
    switch (action) {
        case HoverVerbosityAction.Increase: {
            ...
            return kb ?
                ( localize(1236, "Increase Hover Verbosity ({0})", kb.getLabel())) :
                ( localize(1237, "Increase Hover Verbosity"));
        }
        case HoverVerbosityAction.Decrease: {
            const kb = keybindingService.lookupKeybinding(DECREASE_HOVER_VERBOSITY_ACTION_ID);
            return kb ?
                ( localize(1238, "Decrease Hover Verbosity ({0})", kb.getLabel())) :
                ( localize(1239, "Decrease Hover Verbosity"));
        }
    }
}
