...
const $ = $$1;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, ( localize(1417, 'Icon for show next parameter hint.')));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, ( localize(1418, 'Icon for show previous parameter hint.')));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                alert(( localize(1419, "{0}, hint", labelToAnnounce)));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, ( localize(1420, 'Foreground color of the active item in the parameter hint.')));
