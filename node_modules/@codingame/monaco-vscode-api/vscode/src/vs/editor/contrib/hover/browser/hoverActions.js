...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1205, "Show or Focus Hover")),
            metadata: {
                        ...
                        schema: {
                            ...
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        ( localize(1207, 'The hover will not automatically take focus.')),
                                        ( localize(1208, 'The hover will take focus only if it is already visible.')),
                                        ( localize(1209, 'The hover will automatically take focus when it appears.')),
                                    ],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1210, "Show Definition Preview Hover")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1211, 'Show the definition preview hover in the editor.')),
            },
        });
    }
    run(accessor, editor) {
...
class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1212, "Hide Hover")),
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1213, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(1214, 'Scroll up the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1215, "Scroll Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1216, 'Scroll down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1217, "Scroll Left Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1218, 'Scroll left the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1219, "Scroll Right Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1220, 'Scroll right the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1221, "Page Up Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1222, 'Page up the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1223, "Page Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1224, 'Page down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1225, "Go To Top Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1226, 'Go to the top of the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1227, "Go To Bottom Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
                primary: KeyCode.End,
            ...
            metadata: {
                description: ( localize2(1228, 'Go to the bottom of the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
