...
let ReferenceWidget = class ReferenceWidget extends PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = this._instantiationService.createInstance(TextModel, ( localize(1180, "no preview available")), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null);
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle('');
            this._messageContainer.innerText = ( localize(1181, "No results"));
    ...
    async _revealReference(reference, revealParent) {
        ...
        if (reference.uri.scheme !== Schemas.inMemory) {
            ...
            this.setTitle(( localize(1182, "References")));
        }
