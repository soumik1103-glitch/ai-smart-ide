...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, ( localize(1310, 'Icon for show next parameter hint.')));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, ( localize(1311, 'Icon for show previous parameter hint.')));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    createCommandAction(commandId, label, iconClassName) {
        ...
        let tooltip = label;
        if (kb) {
            tooltip = ( localize(1312, '{0} ({1})', label, kb.getLabel()));
        }
    ...
    constructor(editor, withBorder, _position, _currentSuggestionIdx, _suggestionCount, _extraCommands, _warning, _relayout, _commandService, instantiationService, keybindingService, _contextKeyService, _menuService) {
        ...
        this.previousAction = this._register(this.createCommandAction(showPreviousInlineSuggestionActionId, ( localize(1313, 'Previous')), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon)));
        ...
        this.nextAction = this._register(this.createCommandAction(showNextInlineSuggestionActionId, ( localize(1314, 'Next')), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon)));
