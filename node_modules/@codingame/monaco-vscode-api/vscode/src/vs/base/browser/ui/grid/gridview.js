...
import { LayoutPriority, SplitView, Sizing } from '../splitview/splitview.js';
...
import * as gridview from './gridview.css';

registerCss(gridview);
const defaultStyles = {
...
export { GridView, LayoutPriority, Orientation, Sizing, orthogonal };
