...
import { $, getWindow, append, trackFocus, EventType, addDisposableListener, EventHelper, isHTMLElement, clearNode, getActiveElement } from '../../dom.js';
...
class Pane extends Disposable {
    ...
    getAriaHeaderLabel(title) {
        return localize(30, "{0} Section", title);
    }
    constructor(options) {
        super();
