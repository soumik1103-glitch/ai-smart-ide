...
import { $ as $$1, ModifierKeyEmitter, addDisposableListener, EventType, getWindow, isAncestor, scheduleAtNextAnimationFrame, getDomNodeZoomLevel } from '../../dom.js';
import { StandardKeyboardEvent } from '../../keyboardEvent.js';
import { StandardMouseEvent } from '../../mouseEvent.js';
import { Gesture, EventType as EventType$1 } from '../../touch.js';
import { cleanMnemonic, MENU_MNEMONIC_REGEX, HorizontalDirection, MENU_ESCAPED_MNEMONIC_REGEX, VerticalDirection, Menu } from './menu.js';
...
import { KeyCode, KeyMod as KeyMod$1, ScanCodeUtils, ScanCode } from '../../../common/keyCodes.js';
...
import * as menubar from './menubar.css';
...
class MenuBar extends Disposable {
    ...
    createOverflowMenu() {
        const label = this.isCompact ? ( localize(27, 'Application Menu')) : ( localize(28, 'More'));
