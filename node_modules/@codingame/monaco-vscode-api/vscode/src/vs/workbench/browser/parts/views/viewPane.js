...
const viewPaneContainerExpandedIcon = registerIcon('view-pane-container-expanded', Codicon.chevronDown, ( localize(3698, 'Icon for an expanded view pane container.')));
const viewPaneContainerCollapsedIcon = registerIcon('view-pane-container-collapsed', Codicon.chevronRight, ( localize(3699, 'Icon for a collapsed view pane container.')));
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: ( localize(3700, "{0} actions", this.title)),
    ...
    _getAriaLabel(title, description) {
        ...
        return localize(3701, 'Use Alt+F1 for accessibility help {0}', title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
