...
let NotificationsCenter = class NotificationsCenter extends Themable {
    ...
    updateTitle() {
        ...
        if (this.model.notifications.length === 0) {
            notificationsCenterTitle.textContent = ( localize(3546, "No new notifications"));
            clearAllAction.enabled = false;
        }
        else {
            notificationsCenterTitle.textContent = ( localize(3547, "Notifications"));
    ...
    create() {
        ...
        const notificationsToolBar = this._register(( new ActionBar(toolbarContainer, {
            ariaLabel: ( localize(3548, "Notification Center Actions")),
            actionRunner,
                    ...
                    return this._register(this.instantiationService.createInstance(DropdownMenuActionViewItem, action, {
                        getActions() {
                            const actions = [toAction({
                                    ...
                                    label: that.notificationService.getFilter() === NotificationsFilter.OFF ? ( localize(3549, "Enable Do Not Disturb Mode")) : ( localize(3550, "Disable Do Not Disturb Mode")),
                            ...
                            if (sortedFilters.length > NotificationsCenter_1.MAX_NOTIFICATION_SOURCES) {
                                actions.push(( new Separator()));
                                actions.push(that._register(that.instantiationService.createInstance(ToggleDoNotDisturbBySourceAction, ToggleDoNotDisturbBySourceAction.ID, ( localize(3551, "More…")))));
                            }
                            return actions;
                        },
        ...
        this.notificationsList = this.instantiationService.createInstance(NotificationsList, this.notificationsCenterContainer, {
            widgetAriaLabel: ( localize(3552, "Notifications Center"))
        });
