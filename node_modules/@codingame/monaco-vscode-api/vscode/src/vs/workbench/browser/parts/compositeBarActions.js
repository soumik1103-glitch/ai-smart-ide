...
let CompositeBarActionViewItem = class CompositeBarActionViewItem extends BaseActionViewItem {
    ...
    computeTitle() {
        ...
        let title = this.keybindingLabel ? ( localize(3035, "{0} ({1})", this.compositeBarActionItem.name, this.keybindingLabel)) : this.compositeBarActionItem.name;
...
class CompositeOverflowActivityAction extends CompositeBarAction {
    constructor(showMenu) {
        super({
            ...
            name: ( localize(3036, "Additional Views")),
...
let CompositeOverflowActivityActionViewItem = class CompositeOverflowActivityActionViewItem extends CompositeBarActionViewItem {
    ...
    getActions() {
        return (this.getOverflowingComposites().map(composite => {
            ...
            if (suffix) {
                action.label = ( localize(3037, "{0} ({1})", composite.name, suffix));
            }
            else {
...
let CompositeActionViewItem = class CompositeActionViewItem extends CompositeBarActionViewItem {
    ...
    showContextMenu(container) {
        ...
        if (isPinned) {
            this.toggleCompositePinnedAction.label = ( localize(3038, "Hide '{0}'", this.compositeBarActionItem.name));
            this.toggleCompositePinnedAction.checked = false;
            this.toggleCompositePinnedAction.enabled = this.compositeBar.getPinnedCompositeIds().length > 1;
        }
        else {
            this.toggleCompositePinnedAction.label = ( localize(3039, "Keep '{0}'", this.compositeBarActionItem.name));
        ...
        if (isBadgeEnabled) {
            this.toggleCompositeBadgeAction.label = ( localize(3040, "Hide Badge"));
        }
        else {
            this.toggleCompositeBadgeAction.label = ( localize(3041, "Show Badge"));
        }
...
class ToggleCompositePinnedAction extends Action {
    constructor(activity, compositeBar) {
        super('show.toggleCompositePinned', activity ? activity.name : ( localize(3042, "Toggle View Pinned")));
...
class ToggleCompositeBadgeAction extends Action {
    constructor(compositeBarActionItem, compositeBar) {
        super('show.toggleCompositeBadge', compositeBarActionItem ? compositeBarActionItem.name : ( localize(3043, "Toggle View Badge")));
