...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, ( localize(3098, 'Icon for the separator in the breadcrumbs.')));
let BreadcrumbsControl = class BreadcrumbsControl {
    ...
    static { this.CK_BreadcrumbsPossible = ( new RawContextKey('breadcrumbsPossible', false, ( localize(3099, "Whether the editor can show breadcrumbs")))); }
    static { this.CK_BreadcrumbsVisible = ( new RawContextKey('breadcrumbsVisible', false, ( localize(3100, "Whether breadcrumbs are currently visible")))); }
    static { this.CK_BreadcrumbsActive = ( new RawContextKey('breadcrumbsActive', false, ( localize(3101, "Whether breadcrumbs have focus")))); }
        ...
        const updateBreadcrumbs = () => {
            ...
            if (items.length === 0) {
                ...
                this._widget.setItems([new (class extends BreadcrumbsItem {
                        render(container) {
                            container.textContent = ( localize(3102, "no elements"));
                        }
                        equals(other) {
                            return other === this;
                        }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3103, "Toggle Breadcrumbs")),
            shortTitle: ( localize2(3104, "Breadcrumbs")),
            category: Categories.View,
            toggled: {
                condition: ( ContextKeyExpr.equals('config.breadcrumbs.enabled', true)),
                title: ( localize(3105, "Breadcrumbs")),
                mnemonicTitle: ( localize(3106, "&&Breadcrumbs"))
            },
            menu: [
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3107, "Focus and Select Breadcrumbs")),
...
registerAction2(class FocusBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3108, "Focus Breadcrumbs")),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class CopyBreadcrumbPath extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3109, "Copy Breadcrumbs Path")),
            category: Categories.View,
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            f1: true,
            menu: [{
