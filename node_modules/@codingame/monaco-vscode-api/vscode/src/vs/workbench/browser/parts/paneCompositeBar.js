...
let PaneCompositeBar = class PaneCompositeBar extends Disposable {
    ...
    getContextMenuActionsForComposite(compositeId) {
        ...
        actions.push(( new SubmenuAction('moveToMenu', ( localize(3588, "Move To")), moveActions)));
        if (defaultLocation !== currentLocation) {
            actions.push(toAction({
                id: 'resetLocationAction', label: ( localize(3589, "Reset Location")), run: () => {
    ...
    createMoveAction(viewContainer, newLocation, defaultLocation) {
        return toAction({
            ...
            label: newLocation === ViewContainerLocation.Panel ? ( localize(3590, "Panel")) : newLocation === ViewContainerLocation.Sidebar ? ( localize(3591, "Primary Side Bar")) : ( localize(3592, "Secondary Side Bar")),
            run: () => {
                let index;
