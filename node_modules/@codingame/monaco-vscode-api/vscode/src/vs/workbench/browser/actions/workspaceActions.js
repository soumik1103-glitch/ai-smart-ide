...
class OpenFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2959, 'Open Folder...')),
            category: Categories.File,
            f1: true,
...
class OpenFileFolderAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(2960, 'Open...')); }
    constructor() {
        super({
...
class OpenWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2961, 'Open Workspace from File...')),
            category: Categories.File,
            f1: true,
...
class CloseWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2962, 'Close Workspace')),
...
class OpenWorkspaceConfigFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2963, 'Open Workspace Configuration File')),
            category: workspacesCategory,
            f1: true,
...
class RemoveRootFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2964, 'Remove Folder from Workspace...')),
            category: workspacesCategory,
            f1: true,
...
class SaveWorkspaceAsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2965, 'Save Workspace As...')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2966, 'Duplicate As Workspace in New Window')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenFolderAction.ID,
        title: ( localize(2968, "Open &&Folder..."))
    },
    order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenWorkspaceAction.ID,
        title: ( localize(2970, "Open Wor&&kspace from File..."))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(2971, "A&&dd Folder to Workspace..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: SaveWorkspaceAsAction.ID,
        title: ( localize(2972, "Save Workspace As..."))
    },
    order: 2,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: DuplicateWorkspaceInNewWindowAction.ID,
        title: ( localize(2973, "Duplicate Workspace"))
    },
    order: 3,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(2974, "Close &&Folder"))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(2975, "Close &&Workspace"))
    },
    order: 3,
