...
let NotificationAccessibilityProvider = class NotificationAccessibilityProvider {
    ...
    getAriaLabel(element) {
        ...
        if (this._configurationService.getValue('accessibility.verbosity.notification')) {
            accessibleViewHint = keybinding ? ( localize(3562, "Inspect the response in the accessible view with {0}", keybinding)) : ( localize(
                3563,
        ...
        if (!element.source) {
            return withSeverityPrefix(accessibleViewHint ? ( localize(3564, "{0}, notification, {1}", element.message.raw, accessibleViewHint)) : ( localize(3565, "{0}, notification", element.message.raw)), element.severity);
        }
    ...
    getWidgetAriaLabel() {
        return this._options.widgetAriaLabel ?? ( localize(3568, "Notifications List"));
    }
    getRole() {
        return 'dialog';
    }
