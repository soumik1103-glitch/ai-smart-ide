...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2720, 'Inspect Context Keys')),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2721, 'Toggle Screencast Mode')),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2722, "Log Storage Database Contents")),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        )), ( localize(2724, "Open developer tools from the menu and select the Console tab.")));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2725, "Log Working Copies")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2726, 'Remove Large Storage Database Entries...')),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localize(
                                2727,
                                "Scope: {0}, Target: {1}",
                                scope === StorageScope.APPLICATION ? ( localize(2728, "Global")) : scope === StorageScope.PROFILE ? ( localize(2729, "Profile")) : ( localize(2730, "Workspace")),
                                target === StorageTarget.MACHINE ? ( localize(2731, "Machine")) : ( localize(2732, "User"))
                            )),
                        });
                    }
                }
        ...
        const selectedItems = await ( new Promise(resolve => {
            ...
            picker.customLabel = ( localize(2733, "Remove"));
            picker.placeholder = ( localize(2734, "Select large entries to remove from storage"));
            if (items.length === 0) {
                picker.description = ( localize(2735, "There are no large storage entries to remove."));
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            ...
            primaryButton: ( localize(2738, "&&Remove"))
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2739, 'Start Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2740, 'Snapshot Tracked Disposables')),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2741, 'Stop Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class PolicyDiagnosticsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2742, 'Policy Diagnostics')),
            category: Categories.Developer,
            f1: true
        });
    }
...
configurationRegistry.registerConfiguration({
    id: 'screencastMode',
    order: 9,
    title: ( localize(2743, "Screencast Mode")),
    type: 'object',
    properties: {
        ...
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: ( localize(2746, "Options for customizing the keyboard overlay in screencast mode.")),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2747, "Show raw keys."))
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2748, "Show keyboard shortcuts."))
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2749, "Show command names."))
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: ( localize(2750, "Show command group names, when commands are also shown."))
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2751, "Show single editor cursor move commands."))
                }
            },
            default: {
                'showKeys': true,
