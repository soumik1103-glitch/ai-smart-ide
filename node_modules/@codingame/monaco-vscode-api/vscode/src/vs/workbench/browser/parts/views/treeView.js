...
const noDataProviderMessage = ( localize(3690, "There is no data provider registered that can provide view data."));
...
let AbstractTreeView = class AbstractTreeView extends Disposable {
    ...
    initializeShowCollapseAllAction(startingValue = false) {
        if (!this.collapseAllContext) {
            this.collapseAllContextKey = ( new RawContextKey(`treeView.${this.id}.enableCollapseAll`, startingValue, ( localize(3691, "Whether the tree view with id {0} enables collapse all.", this.id))));
    ...
    initializeShowRefreshAction(startingValue = false) {
        if (!this.refreshContext) {
            this.refreshContextKey = ( new RawContextKey(`treeView.${this.id}.enableRefresh`, startingValue, ( localize(3692, "Whether the tree view with id {0} enables refresh.", this.id))));
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize(3694, "Collapse All")),
                    menu: {
                        id: MenuId.ViewTitle,
