...
import { TestControllerCapability, TestsDiffOp, isStartControllerTests, TestResultState, AbstractIncrementalTestCollection } from '../../contrib/testing/common/testTypes.js';
...
import { TestMessage, TestRunProfileKind, Position, location, TestCoverage, TestResults, Range, TestItem, TestTag } from './extHostTypeConverters.js';
import { TestRunRequest, FileCoverage, TestRunProfileBase } from './extHostTypes.js';
...
let ExtHostTesting = class ExtHostTesting extends Disposable {
    ...
    async runTests(req, token = CancellationToken.None) {
        ...
        await this.proxy.$runTests({
            ...
            group: TestRunProfileKind.from(profile.kind),
            targets: [{
...
class TestRunCoordinator {
    ...
    createTestRun(extension, controllerId, collection, request, name, persist) {
        ...
        this.proxy.$startedExtensionTestRun({
            ...
            profile: profile && { group: TestRunProfileKind.from(profile.kind), id: profile.profileId },
...
class TestRunProfileImpl extends TestRunProfileBase {
    ...
    constructor(proxy, profiles, activeProfiles, onDidChangeActiveProfiles, controllerId, profileId, _label, kind, runHandler, _isDefault = false, _tag = undefined, _supportsContinuousRun = false) {
        ...
        const groupBitset = TestRunProfileKind.from(kind);
        if (_isDefault) {
