...
const VIEWS_LOG_NAME = ( localize(4215, "Views"));
const defaultViewIcon = registerIcon('default-view-icon', Codicon.window, ( localize(4216, 'Default view icon.')));
var Extensions;
(function (Extensions) {
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw ( new Error(( localize(4217, "A view with id '{0}' is already registered", viewDescriptor.id))));
            }
...
class NoTreeViewError extends Error {
    constructor(treeViewId) {
        super(( localize(4218, 'No tree view with id \'{0}\' registered.', treeViewId)));
