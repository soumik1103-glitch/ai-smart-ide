...
const OUTPUT_VIEW_BACKGROUND = registerColor('outputView.background', null, ( localize(4097, "Output view background color.")));
registerColor('outputViewStickyScroll.background', OUTPUT_VIEW_BACKGROUND, ( localize(4098, "Output view sticky scroll background color.")));
...
registerColor('activityBarTop.background', null, ( localize(4141, "Background color of the activity bar when set to top / bottom.")));
...
registerColor('panelInput.border', {
    ...
    hcDark: inputBorder,
    hcLight: inputBorder
}, ( localize(4150, "Input box border for inputs in the panel.")));
...
const PANEL_STICKY_SCROLL_BACKGROUND = registerColor('panelStickyScroll.background', PANEL_BACKGROUND, ( localize(4157, "Background color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_BORDER = registerColor('panelStickyScroll.border', null, ( localize(4158, "Border color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_SHADOW = registerColor('panelStickyScroll.shadow', scrollbarShadow, ( localize(4159, "Shadow color of sticky scroll in the panel.")));
...
const STATUS_BAR_REMOTE_ITEM_BACKGROUND = registerColor('statusBarItem.remoteBackground', ACTIVITY_BAR_BADGE_BACKGROUND, ( localize(4162, "Background color for the remote indicator on the status bar.")));
const STATUS_BAR_REMOTE_ITEM_FOREGROUND = registerColor('statusBarItem.remoteForeground', ACTIVITY_BAR_BADGE_FOREGROUND, ( localize(4163, "Foreground color for the remote indicator on the status bar.")));
...
registerColor('statusBarItem.offlineBackground', '#6c1717', ( localize(4166, "Status bar item background color when the workbench is offline.")));
registerColor('statusBarItem.offlineForeground', STATUS_BAR_REMOTE_ITEM_FOREGROUND, ( localize(4167, "Status bar item foreground color when the workbench is offline.")));
...
const EXTENSION_BADGE_BACKGROUND = registerColor('extensionBadge.remoteBackground', ACTIVITY_BAR_BADGE_BACKGROUND, ( localize(4170, "Background color for the remote badge in the extensions view.")));
const EXTENSION_BADGE_FOREGROUND = registerColor('extensionBadge.remoteForeground', ACTIVITY_BAR_BADGE_FOREGROUND, ( localize(4171, "Foreground color for the remote badge in the extensions view.")));
...
const SIDE_BAR_STICKY_SCROLL_BACKGROUND = registerColor('sideBarStickyScroll.background', SIDE_BAR_BACKGROUND, ( localize(4183, "Background color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_BORDER = registerColor('sideBarStickyScroll.border', null, ( localize(4184, "Border color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_SHADOW = registerColor('sideBarStickyScroll.shadow', scrollbarShadow, ( localize(4185, "Shadow color of sticky scroll in the side bar.")));
const TITLE_BAR_ACTIVE_FOREGROUND = registerColor('titleBar.activeForeground', {
    dark: '#CCCCCC',
    light: '#333333',
    hcDark: '#FFFFFF',
    hcLight: '#292929'
}, ( localize(4186, "Title bar foreground when the window is active.")));
const TITLE_BAR_INACTIVE_FOREGROUND = registerColor('titleBar.inactiveForeground', {
    dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    hcDark: null,
    hcLight: '#292929'
}, ( localize(4187, "Title bar foreground when the window is inactive.")));
const TITLE_BAR_ACTIVE_BACKGROUND = registerColor('titleBar.activeBackground', {
    dark: '#3C3C3C',
    light: '#DDDDDD',
    hcDark: '#000000',
    hcLight: '#FFFFFF'
}, ( localize(4188, "Title bar background when the window is active.")));
const TITLE_BAR_INACTIVE_BACKGROUND = registerColor('titleBar.inactiveBackground', {
    dark: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    hcDark: null,
    hcLight: null,
}, ( localize(4189, "Title bar background when the window is inactive.")));
const TITLE_BAR_BORDER = registerColor('titleBar.border', {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(4190, "Title bar border color.")));
const MENUBAR_SELECTION_FOREGROUND = registerColor('menubar.selectionForeground', TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4191, "Foreground color of the selected menu item in the menubar.")));
const MENUBAR_SELECTION_BACKGROUND = registerColor('menubar.selectionBackground', {
    ...
    hcDark: null,
    hcLight: null,
}, ( localize(4192, "Background color of the selected menu item in the menubar.")));
registerColor('menubar.selectionBorder', {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder,
}, ( localize(4193, "Border color of the selected menu item in the menubar.")));
registerColor('commandCenter.foreground', TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4194, "Foreground color of the command center")), false);
registerColor('commandCenter.activeForeground', MENUBAR_SELECTION_FOREGROUND, ( localize(4195, "Active foreground color of the command center")), false);
registerColor('commandCenter.inactiveForeground', TITLE_BAR_INACTIVE_FOREGROUND, ( localize(4196, "Foreground color of the command center when the window is inactive")), false);
const COMMAND_CENTER_BACKGROUND = registerColor('commandCenter.background', { dark: ( Color.white.transparent(0.05)), hcDark: null, light: ( Color.black.transparent(0.05)), hcLight: null }, ( localize(4197, "Background color of the command center")), false);
registerColor('commandCenter.activeBackground', { dark: ( Color.white.transparent(0.08)), hcDark: MENUBAR_SELECTION_BACKGROUND, light: ( Color.black.transparent(0.08)), hcLight: MENUBAR_SELECTION_BACKGROUND }, ( localize(4198, "Active background color of the command center")), false);
registerColor('commandCenter.border', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcDark: contrastBorder, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcLight: contrastBorder }, ( localize(4199, "Border color of the command center")), false);
registerColor('commandCenter.activeBorder', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcDark: TITLE_BAR_ACTIVE_FOREGROUND, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcLight: TITLE_BAR_ACTIVE_FOREGROUND }, ( localize(4200, "Active border color of the command center")), false);
registerColor('commandCenter.inactiveBorder', ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), ( localize(4201, "Border color of the command center when the window is inactive")), false);
