...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: ( new MarkdownString()).appendText(( localize(6445, "Click to add a breakpoint"))),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? ( localize(6446, "Logpoint")) : ( localize(6447, "Breakpoint"));
                        const disabledBreakpointDialogMessage = ( localize(
                            ...
                            logPoint ? ( localize(6449, "message")) : ( localize(6450, "condition"))
                        ));
                        ...
                        await this.dialogService.prompt({
                            ...
                            buttons: [
                                {
                                    label: ( localize(6452, "&&Remove {0}", breakpointType)),
                                ...
                                },
                                {
                                    label: ( localize(
                                        6453,
                                        "{0} {1}",
                                        enabled ? ( localize(6454, "&&Disable")) : ( localize(6455, "&&Enable")),
                                        breakpointType
                                    )),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? ( localize(6446, "Logpoint")) : ( localize(6447, "Breakpoint"));
            actions.push(toAction({
                id: 'debug.removeBreakpoint', label: ( localize(6456, "Remove {0}", breakpointType)), enabled: true, run: async () => {
                    await this.debugService.removeBreakpoints(breakpoints[0].getId());
                }
            }));
            actions.push(toAction({
                id: 'workbench.debug.action.editBreakpointAction',
                label: ( localize(6457, "Edit {0}...", breakpointType)),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: breakpoints[0].enabled ? ( localize(6458, "Disable {0}", breakpointType)) : ( localize(6459, "Enable {0}", breakpointType)),
                enabled: true,
            ...
            actions.push(( new SubmenuAction('debug.removeBreakpoints', ( localize(6460, "Remove Breakpoints")), ( sorted.map(bp => toAction({
                id: 'removeInlineBreakpoint',
                label: bp.column ? ( localize(6461, "Remove Inline Breakpoint on Column {0}", bp.column)) : ( localize(6462, "Remove Line Breakpoint")),
                enabled: true,
                run: () => this.debugService.removeBreakpoints(bp.getId())
            }))))));
            actions.push(( new SubmenuAction('debug.editBreakpoints', ( localize(6463, "Edit Breakpoints")), ( sorted.map(bp => toAction({
                id: 'editBreakpoint',
                label: bp.column ? ( localize(6464, "Edit Inline Breakpoint on Column {0}", bp.column)) : ( localize(6465, "Edit Line Breakpoint")),
                enabled: true,
                run: () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column))
            }))))));
            actions.push(( new SubmenuAction('debug.enableDisableBreakpoints', ( localize(6466, "Enable/Disable Breakpoints")), ( sorted.map(bp => toAction({
                id: bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                label: bp.enabled ? (bp.column ? ( localize(6467, "Disable Inline Breakpoint on Column {0}", bp.column)) : ( localize(6468, "Disable Line Breakpoint")))
                    : (bp.column ? ( localize(6469, "Enable Inline Breakpoint on Column {0}", bp.column)) : ( localize(6470, "Enable Line Breakpoint"))),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: ( localize(6474, "Add Triggered Breakpoint...")),
                enabled: true,
        ...
        if (this.debugService.state === State.Stopped) {
            ...
            actions.push(toAction({
                id: 'runToLine',
                label: ( localize(6475, "Run to Line")),
                enabled: true,
...
const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', '#E51400', ( localize(6476, 'Icon color for breakpoints.')));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', '#848484', ( localize(6477, 'Icon color for disabled breakpoints.')));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', '#848484', ( localize(6478, 'Icon color for unverified breakpoints.')));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, ( localize(6479, 'Icon color for the current breakpoint stack frame.')));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', '#89D185', ( localize(6480, 'Icon color for all breakpoint stack frames.')));
