...
const DisassemblyEditorIcon = registerIcon('disassembly-editor-label-icon', Codicon.debug, ( localize(7172, 'Icon of the disassembly editor label.')));
class DisassemblyViewInput extends EditorInput {
    ...
    getName() {
        return localize(7173, "Disassembly");
    }
    getIcon() {
