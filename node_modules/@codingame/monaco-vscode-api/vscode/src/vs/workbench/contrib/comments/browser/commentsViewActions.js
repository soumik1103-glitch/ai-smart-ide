...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6395, "Focus Comments view")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6396, "Clear filter text")),
            keybinding: {
                when: CommentsViewFilterFocusContextKey,
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6397, "Focus comments filter")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6398, "Show Unresolved")),
            category: ( localize(6399, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_UNRESOLVED,
                title: ( localize(6400, "Show Unresolved")),
            },
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6401, "Show Resolved")),
            category: ( localize(6399, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_RESOLVED,
                title: ( localize(6402, "Show Resolved")),
            },
            menu: {
                id: viewFilterSubmenu,
                group: '1_filter',
