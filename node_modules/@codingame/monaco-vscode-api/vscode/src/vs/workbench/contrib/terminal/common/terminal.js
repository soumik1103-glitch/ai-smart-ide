...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(11704, 'Contributes terminal functionality.')),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: ( localize(11705, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(11706, "The ID of the terminal profile provider.")),
                            type: 'string',
                        },
                        title: {
                            description: ( localize(11707, "Title for this terminal profile.")),
                            type: 'string',
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: ( localize(11709, 'Icon path when a light theme is used')),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: ( localize(11710, 'Icon path when a dark theme is used')),
                                            type: 'string'
                                        }
                                    }
                                }]
