...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(8275, 'All')));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(8276, "All active folding range providers")));
