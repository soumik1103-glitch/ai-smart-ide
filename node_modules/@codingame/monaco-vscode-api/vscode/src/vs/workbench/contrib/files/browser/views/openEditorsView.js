...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = ( localize2(8247, "Open Editors")); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(8248, "{0} unsaved", dirty));
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(8247, "Open Editors");
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8249, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(8250, "Flip Layout")),
            mnemonicTitle: ( localize(8251, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8252, "New Untitled Text File")),
            f1: false,
