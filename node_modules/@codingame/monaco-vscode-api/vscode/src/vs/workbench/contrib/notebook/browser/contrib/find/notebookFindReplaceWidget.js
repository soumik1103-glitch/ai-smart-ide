...
const NLS_FIND_INPUT_LABEL = ( localize(9273, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(9274, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(9275, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(9276, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(9277, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(9278, "Close"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(9279, "Toggle Replace"));
const NLS_REPLACE_INPUT_LABEL = ( localize(9280, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(9281, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(9282, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(9283, "Replace All"));
registerIcon('find-filter', Codicon.filter, ( localize(9284, 'Icon for Find Filter in find widget.')));
const NOTEBOOK_FIND_FILTERS = ( localize(9285, "Find Filters"));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localize(9286, "Markdown Source"));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localize(9287, "Rendered Markdown"));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localize(9288, "Code Cell Source"));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localize(9289, "Code Cell Output"));
