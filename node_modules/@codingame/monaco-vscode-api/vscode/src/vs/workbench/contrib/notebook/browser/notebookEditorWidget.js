...
}, ( localize(9597, "The border color for notebook cells.")));
registerColor('notebook.focusedEditorBorder', focusBorder, ( localize(9598, "The color of the notebook cell editor border.")));
const cellStatusIconSuccess = registerColor('notebookStatusSuccessIcon.foreground', debugIconStartForeground, ( localize(9599, "The error icon color of notebook cells in the cell status bar.")));
...
const cellStatusIconError = registerColor('notebookStatusErrorIcon.foreground', errorForeground, ( localize(9601, "The error icon color of notebook cells in the cell status bar.")));
registerColor('notebookStatusRunningIcon.foreground', foreground, ( localize(9602, "The running icon color of notebook cells in the cell status bar.")));
registerColor('notebook.outputContainerBorderColor', null, ( localize(9603, "The border color of the notebook output container.")));
registerColor('notebook.outputContainerBackgroundColor', null, ( localize(9604, "The color of the notebook output container background.")));
registerColor('notebook.cellToolbarSeparator', {
    dark: ( ( Color.fromHex('#808080')).transparent(0.35)),
    light: ( ( Color.fromHex('#808080')).transparent(0.35)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(9605, "The color of the separator in the cell bottom toolbar")));
const focusedCellBackground = registerColor('notebook.focusedCellBackground', null, ( localize(9606, "The background color of a cell when the cell is focused.")));
registerColor('notebook.selectedCellBackground', {
    dark: listInactiveSelectionBackground,
    light: listInactiveSelectionBackground,
    hcDark: null,
    hcLight: null
}, ( localize(9607, "The background color of a cell when the cell is selected.")));
registerColor('notebook.cellHoverBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(9608, "The background color of a cell when the cell is hovered.")));
...
registerColor('notebook.inactiveSelectedCellBorder', {
    ...
    hcDark: focusBorder,
    hcLight: focusBorder
}, ( localize(9610, "The color of the cell's borders when multiple cells are selected.")));
...
}, ( localize(9613, "The background color of notebook cell status bar items.")));
registerColor('notebook.cellInsertionIndicator', focusBorder, ( localize(9614, "The color of the notebook cell insertion indicator.")));
registerColor('notebookScrollbarSlider.background', scrollbarSliderBackground, ( localize(9615, "Notebook scrollbar slider background color.")));
registerColor('notebookScrollbarSlider.hoverBackground', scrollbarSliderHoverBackground, ( localize(9616, "Notebook scrollbar slider background color when hovering.")));
registerColor('notebookScrollbarSlider.activeBackground', scrollbarSliderActiveBackground, ( localize(9617, "Notebook scrollbar slider background color when clicked on.")));
registerColor('notebook.symbolHighlightBackground', {
    dark: ( Color.fromHex('#ffffff0b')),
    light: ( Color.fromHex('#fdff0033')),
    hcDark: null,
    hcLight: null
}, ( localize(9618, "Background color of highlighted cell")));
registerColor('notebook.cellEditorBackground', {
    light: SIDE_BAR_BACKGROUND,
    dark: SIDE_BAR_BACKGROUND,
    hcDark: null,
    hcLight: null
}, ( localize(9619, "Cell editor background color.")));
const notebookEditorBackground = registerColor('notebook.editorBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(9620, "Notebook background color.")));
