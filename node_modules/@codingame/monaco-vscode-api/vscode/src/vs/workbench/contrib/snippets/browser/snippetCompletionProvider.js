...
class SnippetCompletion {
    constructor(snippet, range) {
        ...
        this.detail = ( localize(10993, "{0} ({1})", snippet.description || snippet.name, snippet.source));
...
let SnippetCompletionProvider = class SnippetCompletionProvider {
    ...
    _disambiguateSnippets(suggestions) {
        ...
        for (let i = 0; i < suggestions.length; i++) {
            ...
            if (to > i + 1) {
                suggestions[i].label.label = ( localize(10994, "{0}, {1}", suggestions[i].label.label, suggestions[i].snippet.name));
                i = to;
            }
        }
    }
