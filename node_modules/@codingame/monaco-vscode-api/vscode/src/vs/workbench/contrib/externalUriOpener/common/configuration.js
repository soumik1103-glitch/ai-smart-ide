...
const externalUriOpenersConfigurationNode = {
    ...
    properties: {
        [externalUriOpenersSettingId]: {
            type: 'object',
            markdownDescription: ( localize(7884, "Configure the opener to use for external URIs (http, https).")),
            defaultSnippets: [{
                    body: {
                        'example.com': '$1'
                    }
            ...
            additionalProperties: {
                anyOf: [
                    ...
                    },
                    {
                        ...
                        enumDescriptions: [( localize(7886, "Open using VS Code's standard opener."))],
                    },
