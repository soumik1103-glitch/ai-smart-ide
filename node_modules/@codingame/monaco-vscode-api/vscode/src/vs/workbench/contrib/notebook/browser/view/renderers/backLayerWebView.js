...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': ( localize(9719, "Empty markdown cell, double-click or press enter to edit.")),
            'notebook-cell-renderer-not-found-error': ( localize(9720, "No renderer found for '$0'")),
            'notebook-cell-renderer-fallbacks-exhausted': ( localize(9721, "Could not render content for '$0'")),
    ...
    _createInset(webviewService, content) {
        ...
        const webview = webviewService.createWebviewElement({
            ...
            title: ( localize(9722, "Notebook webview content")),
            options: {
