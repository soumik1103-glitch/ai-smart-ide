        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(6190, 'No matching entries'));
...
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6191, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(6192, "Go to &&Symbol in Editor...")),
            },
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(6193, "Type the name of a symbol to go to.")),
    helpEntries: [
        {
            description: ( localize(6194, "Go to Symbol in Editor")),
            prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
            commandId: GotoSymbolAction.ID,
            commandCenterOrder: 40
        },
        {
            description: ( localize(6195, "Go to Symbol in Editor by Category")),
