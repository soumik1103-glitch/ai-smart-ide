...
const SearchEditorIcon = registerIcon('search-editor-label-icon', Codicon.search, ( localize(10946, 'Icon of the search editor label.')));
let SearchEditorInput = class SearchEditorInput extends EditorInput {
    ...
    getName(maxLength = 12) {
        ...
        if (query) {
            return localize(10947, "Search: {0}", trimToMax(query));
        }
        return localize(10948, "Search");
    }
    setDirty(dirty) {
