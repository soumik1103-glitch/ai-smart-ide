...
function setupTerminalMenus() {
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11608, "&&New Terminal"))
                },
                order: 1
            }
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11609, "New Terminal &&Window")),
        ...
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11610, "&&Split Terminal")),
                    precondition: ( ContextKeyExpr.has(TerminalContextKeyStrings.IsOpen))
                },
                order: 2,
                when: TerminalContextKeys.processSupported
        ...
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11611, "Run &&Active File"))
                },
                order: 3,
                when: TerminalContextKeys.processSupported
            }
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11612, "Run &&Selected Text"))
                },
                order: 4,
                when: TerminalContextKeys.processSupported
            }
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11614, "Copy as HTML"))
                },
                group: TerminalContextMenuGroup.Edit,
                order: 2
            }
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11617, "Select All")),
                },
                group: TerminalContextMenuGroup.Edit,
                order: 3
            }
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11618, "New Terminal With Profile..."))
                },
                group: TerminalContextMenuGroup.Create
            }
        },
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize2(11619, 'Select Default Profile')),
                },
                group: '3_configure'
            }
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11620, "Configure Terminal Settings"))
                },
                group: '3_configure'
            }
        },
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11622, "Configure Tasks..."))
                },
                when: TaskExecutionSupportedContext,
                group: '4_tasks',
                order: 2
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize2(11623, 'Switch Terminal'))
                },
                group: 'navigation',
                order: 0,
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.Clear,
                    title: ( localize(11624, "Clear Terminal")),
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.RunActiveFile,
                    title: ( localize(11625, "Run Active File")),
                    icon: Codicon.run
                },
                group: 'navigation',
                order: 7,
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.RunSelectedText,
                    title: ( localize(11626, "Run Selected Text")),
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11627, "Start Dictation")),
                },
                group: 'navigation',
                order: 9,
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11628, "Stop Dictation")),
                },
                group: 'navigation',
                order: 9,
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11630, "Change Icon..."))
                },
                group: TerminalContextMenuGroup.Edit
            }
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11631, "Change Color..."))
                },
                group: TerminalContextMenuGroup.Edit
            }
        },
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11632, "Join Terminals"))
                },
    ...
    for (const menuId of [MenuId.EditorTitle, MenuId.CompactWindowEditorTitle]) {
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StartVoice,
                title: ( localize(11633, "Start Dictation")),
                icon: Codicon.mic
            },
            group: 'navigation',
            order: 9,
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StopVoice,
                title: ( localize(11634, "Stop Dictation")),
                icon: Codicon.run
            },
            group: 'navigation',
            order: 10,
...
function getTerminalActionBarArgs(location, profiles, defaultProfileName, contributedProfiles, terminalService, dropdownMenu, disposableStore) {
    ...
    for (const p of profiles) {
        ...
        dropdownActions.push(disposableStore.add(( new Action(TerminalCommandId.NewWithProfile, isDefault ? ( localize(11635, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
            await terminalService.createAndFocusTerminal(options);
        }))));
        submenuActions.push(disposableStore.add(( new Action(TerminalCommandId.Split, isDefault ? ( localize(11635, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
    ...
    for (const contributed of contributedProfiles) {
        ...
        const title = isDefault ? ( localize(11635, "{0} (Default)", contributed.title.replace(/[\n\r\t]/g, ''))) : contributed.title.replace(/[\n\r\t]/g, '');
        dropdownActions.push(disposableStore.add(( new Action(
            'contributed',
            title,
            undefined,
    ...
    if (dropdownActions.length > 0) {
        dropdownActions.push(( new SubmenuAction('split.profile', ( localize(11636, 'Split Terminal with Profile')), submenuActions)));
        dropdownActions.push(( new Separator()));
    }
    const actions = dropdownMenu.getActions();
    dropdownActions.push(...Separator.join(...( actions.map(a => a[1]))));
    const dropdownAction = disposableStore.add(( new Action('refresh profiles', ( localize(11637, 'Launch Profile...')), 'codicon-chevron-down', true)));
