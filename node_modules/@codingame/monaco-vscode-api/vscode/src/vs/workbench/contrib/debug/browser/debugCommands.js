...
const DEBUG_COMMAND_CATEGORY = ( localize2(6736, 'Debug'));
const RESTART_LABEL = ( localize2(6737, "Restart"));
const STEP_OVER_LABEL = ( localize2(6738, "Step Over"));
const STEP_INTO_LABEL = ( localize2(6739, "Step Into"));
const STEP_INTO_TARGET_LABEL = ( localize2(6740, "Step Into Target"));
const STEP_OUT_LABEL = ( localize2(6741, "Step Out"));
const PAUSE_LABEL = ( localize2(6742, "Pause"));
const DISCONNECT_LABEL = ( localize2(6743, "Disconnect"));
const DISCONNECT_AND_SUSPEND_LABEL = ( localize2(6744, "Disconnect and Suspend"));
const STOP_LABEL = ( localize2(6745, "Stop"));
const CONTINUE_LABEL = ( localize2(6746, "Continue"));
const FOCUS_SESSION_LABEL = ( localize2(6747, "Focus Session"));
const SELECT_AND_START_LABEL = ( localize2(6748, "Select and Start Debugging"));
const DEBUG_CONFIGURE_LABEL = ( localize(6749, "Open '{0}'", 'launch.json'));
const DEBUG_START_LABEL = ( localize2(6750, "Start Debugging"));
const DEBUG_RUN_LABEL = ( localize2(6751, "Start Without Debugging"));
const NEXT_DEBUG_CONSOLE_LABEL = ( localize2(6752, "Focus Next Debug Console"));
const PREV_DEBUG_CONSOLE_LABEL = ( localize2(6753, "Focus Previous Debug Console"));
const OPEN_LOADED_SCRIPTS_LABEL = ( localize2(6754, "Open Loaded Script..."));
const CALLSTACK_TOP_LABEL = ( localize2(6755, "Navigate to Top of Call Stack"));
const CALLSTACK_BOTTOM_LABEL = ( localize2(6756, "Navigate to Bottom of Call Stack"));
const CALLSTACK_UP_LABEL = ( localize2(6757, "Navigate Up Call Stack"));
const CALLSTACK_DOWN_LABEL = ( localize2(6758, "Navigate Down Call Stack"));
const COPY_EVALUATE_PATH_LABEL = ( localize2(6759, "Copy as Expression"));
const COPY_VALUE_LABEL = ( localize2(6760, "Copy Value"));
const COPY_ADDRESS_LABEL = ( localize2(6761, "Copy Address"));
const ADD_TO_WATCH_LABEL = ( localize2(6762, "Add to Watch"));
const SELECT_DEBUG_CONSOLE_LABEL = ( localize2(6763, "Select Debug Console"));
const SELECT_DEBUG_SESSION_LABEL = ( localize2(6764, "Select Debug Session"));
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor) => {
            ...
            if (source) {
                ...
                if (targets && targets.length) {
                    ...
                    if (targets.length > 1) {
                        ...
                        const pick = await quickInputService.pick(picks, { placeHolder: ( localize(6765, "Choose the specific location")) });
                        if (!pick) {
                            return;
                        }
                        id = pick._id;
        ...
        return notificationService.warn(( localize(6766, "No executable code is associated at the current cursor position.")));
    }
});
CommandsRegistry.registerCommand({
    id: CALLSTACK_TOP_ID,
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: JUMP_TO_CURSOR_ID,
        title: ( localize(6767, "Jump to Cursor")),
    ...
    handler: async (accessor, _, context) => {
        ...
        session.stepInTargets(frame.frameId).then(targets => {
            ...
            if (targets?.length) {
                ...
                qp.placeholder = ( localize(6768, "No step targets available"));
            }
        });
    }
});
...
registerAction2(class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6769, "Add Configuration...")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
            menu: {
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: TOGGLE_INLINE_BREAKPOINT_ID,
        title: ( localize(6770, "Add Inline Breakpoint")),
        category: DEBUG_COMMAND_CATEGORY
    },
...
registerAction2(class ToggleExceptionBreakpointsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6771, "Toggle Exception Breakpoints")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = ( localize(6772, "Pick enabled exception breakpoints"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6773, "Attach to Current Code Renderer")),
        });
    }
    async run(accessor) {
