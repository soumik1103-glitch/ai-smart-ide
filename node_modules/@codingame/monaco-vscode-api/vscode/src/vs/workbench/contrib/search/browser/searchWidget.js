...
let SearchWidget = class SearchWidget extends Widget {
    ...
    static { this.REPLACE_ALL_DISABLED_LABEL = ( localize(10906, "Replace All (Submit Search to Enable)")); }
    static { this.REPLACE_ALL_ENABLED_LABEL = (keyBindingService2) => {
        const kb = keyBindingService2.lookupKeybinding(ReplaceAllAction.ID);
        return appendKeyBindingLabel(( localize(10907, "Replace All")), kb);
    }; }
    ...
    renderToggleReplaceButton(parent) {
        const opts = {
            ...
            title: ( localize(10908, "Toggle Replace")),
    ...
    renderSearchInput(parent, options) {
        ...
        const inputOptions = {
            label: ( localize(10909, 'Search: Type Search Term and press Enter to search')),
            validation: (value) => this.validateSearchInput(value),
            placeholder: ( localize(10910, "Search")),
        ...
        this.showContextToggle = ( new Toggle({
            isChecked: false,
            title: appendKeyBindingLabel(( localize(10911, "Toggle Context Lines")), this.keybindingService.lookupKeybinding(ToggleSearchEditorContextLinesCommandId)),
    ...
    renderReplaceInput(parent, options) {
        ...
        this.replaceInput = this._register(( new ContextScopedReplaceInput(replaceBox, this.contextViewService, {
            label: ( localize(10912, 'Replace: Type replace term and press Enter to preview')),
            placeholder: ( localize(10913, "Replace")),
