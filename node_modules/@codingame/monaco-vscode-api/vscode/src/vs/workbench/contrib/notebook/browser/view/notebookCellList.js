...
import { scheduleAtNextAnimationFrame, getWindow, isAncestorOfActiveElement, getActiveElement, findParentWithClass } from '../../../../../base/browser/dom.js';
...
import { CursorAtBoundary, CursorAtLineBoundary, CellRevealType, CellEditState, CellRevealRangeType } from '../notebookBrowser.js';
import { NOTEBOOK_EDITOR_CURSOR_BOUNDARY, NOTEBOOK_EDITOR_CURSOR_LINE_BOUNDARY, diff, CellKind, SelectionStateType } from '../../common/notebookCommon.js';
import { cellRangesEqual, cellRangesToIndexes, reduceCellRanges } from '../../common/notebookRange.js';
...
let NotebookCellList = class NotebookCellList extends WorkbenchList {
    ...
    domFocus() {
        ...
        const activeElement = getActiveElement(this.view.domNode.ownerDocument);
        if (activeElement && focusedDomElement && focusedDomElement.contains(activeElement)) {
            return;
        }
        if (!isMacintosh && activeElement && !!findParentWithClass(activeElement, 'context-view')) {
            return;
        }
        super.domFocus();
    }
