...
let TextFileEditor = class TextFileEditor extends AbstractTextCodeEditor {
    ...
    getTitle() {
        ...
        return localize(7892, "Text File Editor");
    }
    get input() {
        return this._input;
    }
    ...
    async handleSetInputError(error, input, options) {
        ...
        if (error.fileOperationResult === FileOperationResult.FILE_IS_DIRECTORY) {
            ...
            actions.push(toAction({
                id: 'workbench.files.action.openFolder', label: ( localize(7893, "Open Folder")), run: async () => {
            ...
            if (this.contextService.isInsideWorkspace(input.preferredResource)) {
                actions.push(toAction({
                    id: 'workbench.files.action.reveal', label: ( localize(7894, "Reveal Folder")), run: async () => {
        ...
        if (error.fileOperationResult === FileOperationResult.FILE_NOT_FOUND &&
            ...
            const fileNotFoundError = createEditorOpenError(( new FileOperationError(( localize(7898, "The editor could not be opened because the file was not found.")), FileOperationResult.FILE_NOT_FOUND)), [
                toAction({
                    id: 'workbench.files.action.createMissingFile', label: ( localize(7899, "Create File")), run: async () => {
