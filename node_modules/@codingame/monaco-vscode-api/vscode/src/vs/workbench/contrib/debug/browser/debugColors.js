...
const debugToolBarBackground = registerColor('debugToolBar.background', {
    ...
    hcDark: '#000000',
    hcLight: '#FFFFFF'
}, ( localize(6724, "Debug toolbar background color.")));
const debugToolBarBorder = registerColor('debugToolBar.border', null, ( localize(6725, "Debug toolbar border color.")));
const debugIconStartForeground = registerColor('debugIcon.startForeground', {
    dark: '#89D185',
    light: '#388A34',
    hcDark: '#89D185',
    hcLight: '#388A34'
}, ( localize(6726, "Debug toolbar icon for start debugging.")));
