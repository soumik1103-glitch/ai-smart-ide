...
let ReplInputHintContentWidget = class ReplInputHintContentWidget extends Disposable {
    ...
    setHint() {
        ...
        if (keybinding && keybindingHintLabel) {
            const actionPart = ( localize(8405, 'Press {0} to execute. ', keybindingHintLabel));
            ...
            const helpInfo = helpKeybinding
                ? ( localize(8406, "Use {0} for accessibility help. ", helpKeybinding))
                : ( localize(8407, "Run the Open Accessibility Help command for more information. "));
