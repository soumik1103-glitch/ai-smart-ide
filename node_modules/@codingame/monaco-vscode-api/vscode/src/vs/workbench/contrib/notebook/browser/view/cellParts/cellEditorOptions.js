...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    'properties': {
        'notebook.lineNumbers': {
            ...
            enum: ['off', 'on'],
            default: 'off',
            markdownDescription: ( localize(9692, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9693, 'Toggle Notebook Line Numbers')),
            shortTitle: ( localize2(9694, 'Line Numbers')),
            ...
            toggled: {
                ...
                title: ( localize(9695, "Line Numbers")),
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(9696, "Show Cell Line Numbers")),
