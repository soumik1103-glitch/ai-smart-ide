...
class ConfigurationRegistry extends Disposable {
    constructor() {
        ...
        this.defaultLanguageConfigurationOverridesNode = {
            id: 'defaultOverrides',
            title: ( localize(1768, "Default Language Configuration Overrides")),
            properties: {}
        };
    ...
    updateOverridePropertyPatternKey() {
        for (const overrideIdentifier of ( this.overrideIdentifiers.values())) {
            ...
            const resourceLanguagePropertiesSchema = {
                type: 'object',
                description: ( localize(1770, "Configure editor settings to be overridden for a language.")),
                errorMessage: ( localize(1771, "This setting does not support per-language configuration.")),
                $ref: resourceLanguageSettingsSchemaId,
            };
...
function validateProperty(property, schema, extensionId) {
    if (!property.trim()) {
        return localize(1772, "Cannot register an empty property");
    }
