...
class HTMLFileSystemProvider extends Disposable {
    ...
    async rename(from, to, opts) {
        try {
            ...
            if (fileHandle) {
                ...
                throw this.createFileSystemProviderError(from, ( localize(1905, "Rename is only supported for files.")), FileSystemProviderErrorCode.Unavailable);
            }
        }
        catch (error) {
            throw this.toFileSystemProviderError(error);
    ...
    toFileSystemProviderError(error) {
        ...
        if (error.name === 'NotAllowedError') {
            error = ( new Error(( localize(1906, "Insufficient permissions. Please retry and allow the operation."))));
