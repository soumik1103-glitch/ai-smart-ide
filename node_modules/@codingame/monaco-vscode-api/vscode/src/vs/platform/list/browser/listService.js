    ...
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            markdownEnumDescriptions: [
                ( localize(1960, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")),
                ( localize(1961, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))
            ],
            default: 'ctrlCmd',
        ...
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: ( localize(1965, "Controls whether clicks in the scrollbar scroll page by page."))
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
            minimum: 4,
            maximum: 40,
            description: ( localize(1966, "Controls tree indentation in pixels."))
        },
        [treeRenderIndentGuidesKey]: {
            type: 'string',
            enum: ['none', 'onHover', 'always'],
            default: 'onHover',
            description: ( localize(1967, "Controls whether the tree should render indent guides."))
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: ( localize(1968, "Controls whether lists and trees have smooth scrolling.")),
        },
        ...
        [fastScrollSensitivityKey]: {
            type: 'number',
            default: 5,
            markdownDescription: ( localize(1970, "Scrolling speed multiplier when pressing `Alt`."))
        },
        [defaultFindModeSettingKey]: {
            ...
            enumDescriptions: [
                ...
                ( localize(1972, "Filter elements when searching."))
            ],
            default: 'highlight',
            description: ( localize(
                1973,
        ...
        [defaultFindMatchTypeSettingKey]: {
            ...
            enumDescriptions: [
                ( localize(1979, "Use fuzzy matching when searching.")),
                ( localize(1980, "Use contiguous matching when searching."))
            ],
            default: 'fuzzy',
            description: ( localize(
                1981,
        ...
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: ( localize(1983, "Controls whether sticky scrolling is enabled in trees.")),
        },
