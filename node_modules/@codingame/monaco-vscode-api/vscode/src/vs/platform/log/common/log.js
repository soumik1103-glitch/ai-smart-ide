...
function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: ( localize(1986, "Trace")) };
        case LogLevel.Debug: return { original: 'Debug', value: ( localize(1987, "Debug")) };
        case LogLevel.Info: return { original: 'Info', value: ( localize(1988, "Info")) };
        case LogLevel.Warning: return { original: 'Warning', value: ( localize(1989, "Warning")) };
        case LogLevel.Error: return { original: 'Error', value: ( localize(1990, "Error")) };
        case LogLevel.Off: return { original: 'Off', value: ( localize(1991, "Off")) };
    }
}
