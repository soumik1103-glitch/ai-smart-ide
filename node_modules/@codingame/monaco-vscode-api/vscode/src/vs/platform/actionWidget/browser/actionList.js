    ...
    renderElement(element, _index, data) {
        ...
        if (element.tooltip) {
            ...
            if (this._supportsPreview && element.canPreview) {
                data.container.title = ( localize(1746, "{0} to Apply, {1} to Preview", actionTitle, previewTitle));
            }
            else {
                data.container.title = ( localize(1747, "{0} to Apply", actionTitle));
            }
        }
        else {
            ...
            accessibilityProvider: {
                getAriaLabel: element => {
                    if (element.kind === ActionListItemKind.Action) {
                        ...
                        if (element.disabled) {
                            label = ( localize(1748, "{0}, Disabled Reason: {1}", label, element.disabled));
                        }
                        return label;
                    }
                    return null;
                },
                getWidgetAriaLabel: () => ( localize(1749, "Action Widget")),
                getRole: (e) => {
                    switch (e.kind) {
