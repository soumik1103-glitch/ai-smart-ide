...
const InQuickInputContextKey = ( new RawContextKey(inQuickInputContextKeyValue, false, ( localize(2015, "Whether keyboard focus is inside the quick input control"))));
...
const QuickInputAlignmentContextKey = ( new RawContextKey(quickInputAlignmentContextKeyValue, 'top', ( localize(2016, "The alignment of the quick input"))));
const quickInputTypeContextKeyValue = 'quickInputType';
const QuickInputTypeContextKey = ( new RawContextKey(quickInputTypeContextKeyValue, undefined, ( localize(2017, "The type of the currently visible quick input"))));
...
const backButton = {
    ...
    tooltip: ( localize(2019, "Back")),
    handle: -1
};
class QuickInput extends Disposable {
    static { this.noPromptMessage = ( localize(2020, "Press 'Enter' to confirm your input or 'Escape' to cancel")); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return localize(2021, "{0}/{1}", this.step, this.totalSteps);
        }
        if (this.step) {
...
class QuickPick extends QuickInput {
    static { this.DEFAULT_ARIA_LABEL = ( localize(2022, "Type to narrow down results.")); }
    constructor(ui) {
        super(ui);
        this._value = '';
    ...
    get okLabel() {
        return this._okLabel ?? ( localize(2023, "OK"));
    }
    set okLabel(okLabel) {
...
class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        this._prompt = prompt;
        this.noValidationMessage = prompt
            ? ( localize(2024, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt))
