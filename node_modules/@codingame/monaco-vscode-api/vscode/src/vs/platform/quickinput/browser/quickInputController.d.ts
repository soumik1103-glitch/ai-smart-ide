...
export declare class QuickInputController extends Disposable {
    ...
    constructor(options: IQuickInputOptions, layoutService: ILayoutService, instantiationService: IInstantiationService, contextKeyService: IContextKeyService, storageService: IStorageService, contextMenuService: IContextMenuService, keybindingService: IKeybindingService);
