            ...
            definitions: {
                icons: {
                    ...
                    properties: {
                        ...
                        fontCharacter: { type: 'string', description: ( localize(2368, 'The font character associated with the icon definition.')) }
                    },
...
const widgetClose = registerIcon('widget-close', Codicon.close, ( localize(2369, 'Icon for the close action in widgets.')));
const gotoPreviousLocation = registerIcon('goto-previous-location', Codicon.arrowUp, ( localize(2370, 'Icon for goto previous editor location.')));
const gotoNextLocation = registerIcon('goto-next-location', Codicon.arrowDown, ( localize(2371, 'Icon for goto next editor location.')));
