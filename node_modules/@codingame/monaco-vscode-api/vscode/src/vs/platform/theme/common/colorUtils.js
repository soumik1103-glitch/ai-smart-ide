...
class ColorRegistry extends Disposable {
    ...
    registerColor(id, defaults, description, needsTransparency = false, deprecationMessage) {
        ...
        if (needsTransparency) {
            ...
            propertySchema.patternErrorMessage = ( localize(2115, 'This color must be transparent or it will obscure content'));
        }
        this.colorSchema.properties[id] = {
            description,
            oneOf: [
                propertySchema,
                { type: 'string', const: DEFAULT_COLOR_CONFIG_VALUE, description: ( localize(2116, 'Use the default color.')) }
            ]
        };
