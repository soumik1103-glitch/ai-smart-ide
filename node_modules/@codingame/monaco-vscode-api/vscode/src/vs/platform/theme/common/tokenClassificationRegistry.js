    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: 'object',
                    description: ( localize(2383, 'Colors and styles for the token.')),
                    properties: {
                        foreground: {
                            type: 'string',
                            description: ( localize(2384, 'Foreground color for the token.')),
                            format: 'color-hex',
                            default: '#ff0000'
                        },
                        background: {
                            type: 'string',
                            deprecationMessage: ( localize(2385, 'Token background colors are currently not supported.'))
                        },
                        fontStyle: {
                            type: 'string',
                            ...
                            defaultSnippets: [
                                { label: ( localize(2388, 'None (clear inherited style)')), bodyText: '""' },
                                { body: 'italic' },
                                { body: 'bold' },
                                { body: 'underline' },
                                { body: 'strikethrough' },
...
function createDefaultTokenClassificationRegistry() {
    ...
    registerTokenType('comment', ( localize(2393, "Style for comments.")), [['comment']]);
    registerTokenType('string', ( localize(2394, "Style for strings.")), [['string']]);
    registerTokenType('keyword', ( localize(2395, "Style for keywords.")), [['keyword.control']]);
    registerTokenType('number', ( localize(2396, "Style for numbers.")), [['constant.numeric']]);
    registerTokenType('regexp', ( localize(2397, "Style for expressions.")), [['constant.regexp']]);
    registerTokenType('operator', ( localize(2398, "Style for operators.")), [['keyword.operator']]);
    registerTokenType('namespace', ( localize(2399, "Style for namespaces.")), [['entity.name.namespace']]);
    registerTokenType('type', ( localize(2400, "Style for types.")), [['entity.name.type'], ['support.type']]);
    registerTokenType('struct', ( localize(2401, "Style for structs.")), [['entity.name.type.struct']]);
    registerTokenType('class', ( localize(2402, "Style for classes.")), [['entity.name.type.class'], ['support.class']]);
    registerTokenType('interface', ( localize(2403, "Style for interfaces.")), [['entity.name.type.interface']]);
    registerTokenType('enum', ( localize(2404, "Style for enums.")), [['entity.name.type.enum']]);
    registerTokenType('typeParameter', ( localize(2405, "Style for type parameters.")), [['entity.name.type.parameter']]);
    registerTokenType('function', ( localize(2406, "Style for functions")), [['entity.name.function'], ['support.function']]);
    registerTokenType('member', ( localize(2407, "Style for member functions")), [], 'method', 'Deprecated use `method` instead');
    registerTokenType('method', ( localize(2408, "Style for method (member functions)")), [['entity.name.function.member'], ['support.function']]);
    registerTokenType('macro', ( localize(2409, "Style for macros.")), [['entity.name.function.preprocessor']]);
    registerTokenType('variable', ( localize(2410, "Style for variables.")), [['variable.other.readwrite'], ['entity.name.variable']]);
    registerTokenType('parameter', ( localize(2411, "Style for parameters.")), [['variable.parameter']]);
    registerTokenType('property', ( localize(2412, "Style for properties.")), [['variable.other.property']]);
    registerTokenType('enumMember', ( localize(2413, "Style for enum members.")), [['variable.other.enummember']]);
    registerTokenType('event', ( localize(2414, "Style for events.")), [['variable.other.event']]);
    registerTokenType('decorator', ( localize(2415, "Style for decorators & annotations.")), [['entity.name.decorator'], ['entity.name.function']]);
    registerTokenType('label', ( localize(2416, "Style for labels. ")), undefined);
    registry.registerTokenModifier('declaration', ( localize(2417, "Style for all symbol declarations.")), undefined);
    registry.registerTokenModifier('documentation', ( localize(2418, "Style to use for references in documentation.")), undefined);
    registry.registerTokenModifier('static', ( localize(2419, "Style to use for symbols that are static.")), undefined);
    registry.registerTokenModifier('abstract', ( localize(2420, "Style to use for symbols that are abstract.")), undefined);
    registry.registerTokenModifier('deprecated', ( localize(2421, "Style to use for symbols that are deprecated.")), undefined);
    registry.registerTokenModifier('modification', ( localize(2422, "Style to use for write accesses.")), undefined);
    registry.registerTokenModifier('async', ( localize(2423, "Style to use for symbols that are async.")), undefined);
    registry.registerTokenModifier('readonly', ( localize(2424, "Style to use for symbols that are read-only.")), undefined);
