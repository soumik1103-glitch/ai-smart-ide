...
const iconForeground = registerColor('icon.foreground', { dark: '#C5C5C5', light: '#424242', hcDark: '#FFFFFF', hcLight: '#292929' }, ( localize(2121, "The default color for icons in the workbench.")));
...
const textLinkForeground = registerColor('textLink.foreground', { light: '#006AB1', dark: '#3794FF', hcDark: '#21A6FF', hcLight: '#0F4A85' }, ( localize(2126, "Foreground color for links in text.")));
...
registerColor('textSeparator.foreground', { light: '#0000002e', dark: '#ffffff2e', hcDark: Color.black, hcLight: '#292929' }, ( localize(2128, "Color for text separators.")));
registerColor('textPreformat.foreground', { light: '#A31515', dark: '#D7BA7D', hcDark: '#FFFFFF', hcLight: '#FFFFFF' }, ( localize(2129, "Foreground color for preformatted text segments.")));
registerColor('textPreformat.background', { light: '#0000001A', dark: '#FFFFFF1A', hcDark: null, hcLight: '#09345f' }, ( localize(2130, "Background color for preformatted text segments.")));
registerColor('textPreformat.border', { light: null, dark: null, hcDark: contrastBorder, hcLight: null }, ( localize(2131, "Border color for preformatted text segments.")));
registerColor('textBlockQuote.background', { light: '#f2f2f2', dark: '#222222', hcDark: null, hcLight: '#F2F2F2' }, ( localize(2132, "Background color for block quotes in text.")));
registerColor('textBlockQuote.border', { light: '#007acc80', dark: '#007acc80', hcDark: Color.white, hcLight: '#292929' }, ( localize(2133, "Border color for block quotes in text.")));
registerColor('textCodeBlock.background', { light: '#dcdcdc66', dark: '#0a0a0a66', hcDark: Color.black, hcLight: '#F2F2F2' }, ( localize(2134, "Background color for code blocks in text.")));
