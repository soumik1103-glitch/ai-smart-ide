...
import { Disposable, MutableDisposable, combinedDisposable, toDisposable, DisposableStore, dispose } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
...
import { APPLICATION_SCOPES, APPLY_ALL_PROFILES_SETTING, TASKS_CONFIGURATION_KEY, MCP_CONFIGURATION_KEY, REMOTE_MACHINE_SCOPES, WORKSPACE_SCOPES, FOLDER_SETTINGS_NAME, FOLDER_SCOPES, LAUNCH_CONFIGURATION_KEY } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/configuration/common/configuration';
...
import { isEmptyObject, isObject } from '@codingame/monaco-vscode-api/vscode/vs/base/common/types';
import { DefaultConfiguration as DefaultConfiguration$1 } from '@codingame/monaco-vscode-api/vscode/vs/platform/configuration/common/configurations';
